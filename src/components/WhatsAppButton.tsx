...
export default function WhatsAppButton() {
  ...
  const href = `https://wa.me/${phone}?text=${encodeURIComponent(
    "Hola Bárbara, tengo una consulta sobre terapia ocupacional."
  )}`;

  // Aparece después de 3 segundos para no interrumpir la primera impresión
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <span className="text-sm font-semibold whitespace-nowrap">¿Tienes dudas?</span>
    </a>
  );
}
